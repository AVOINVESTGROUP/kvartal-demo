      ...
      <div className="relative z-10 mx-auto w-full max-w-kv-container px-5 py-12 sm:py-14 lg:py-18 xl:py-20">
        <div className="min-w-0 max-w-[720px]">
          <div className="mb-4 flex items-center gap-2.5 text-[12px] font-extrabold uppercase tracking-widest text-white/80 before:h-[2px] before:w-[34px] before:bg-kv-gold before:content-[''] sm:text-[13px]">
            Коммерческая недвижимость и инвестиционные объекты
          </div>
          ...
          <h1 className="max-w-[700px] text-[28px] font-black leading-[1.06] tracking-0 min-[420px]:text-[34px] sm:text-[54px] sm:leading-[0.98] lg:text-[64px] xl:text-[72px]">
            KVARTAL: подбор и сопровождение сделок с недвижимостью
          </h1>

          <p className="mt-5 max-w-[620px] text-base leading-relaxed text-white/78 sm:text-xl">
            Работаем с коммерческими объектами, земельными участками, складскими и гостиничными
            активами. Представляем интересы собственников и покупателей в сложных сделках.
          </p>

          <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <a
              href="#objects"
              className="min-h-[52px] rounded-full bg-kv-red px-6 py-3.5 text-center font-extrabold text-white shadow-xl transition-all hover:-translate-y-px hover:bg-kv-red-dark sm:px-8"
            >
              Смотреть объекты
            </a>
            <a
              href="#contacts"
              className="min-h-[52px] rounded-full border border-white/28 bg-white/10 px-6 py-3.5 text-center font-extrabold text-white transition-all hover:bg-white/20 sm:px-8"
            >
              Связаться
            </a>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div className="rounded-kv-form border border-white/12 bg-white/6 p-4">
              ...
              <span className="mt-1 block text-[13px] text-white/68">реальных объектов в работе</span>
            </div>
            <div className="rounded-kv-form border border-white/12 bg-white/6 p-4">
              <span className="block text-3xl font-black text-white">6</span>
              <span className="mt-1 block text-[13px] text-white/68">форматов активов</span>
            </div>
            <div className="rounded-kv-form border border-white/12 bg-white/6 p-4">
              <span className="block text-3xl font-black text-white">1</span>
              <span className="mt-1 block text-[13px] text-white/68">центр сопровождения</span>
            </div>
          </div>
          ...
          <div id="request" className="mt-7 rounded-kv-main border border-white/16 bg-white/10 p-4 shadow-2xl backdrop-blur-xl sm:p-5">
            <div className="mb-3">
              ...
              <p className="mt-1 text-[13px] leading-snug text-white/68">
                Оставьте задачу, и мы свяжемся с вами по телефону +7 (977) 291-95-73.
              </p>
            </div>
            ...
            <form className="grid gap-2.5 sm:grid-cols-2 lg:grid-cols-[1fr,1fr] xl:grid-cols-[1fr,1fr,1.1fr,auto]">
              ...
              <button
                type="submit"
                className="h-11 cursor-pointer rounded-full bg-kv-red px-5 text-sm font-extrabold text-white shadow-lg transition-all hover:bg-kv-red-dark sm:col-span-2 xl:col-span-1"
              >
                Отправить
              </button>
