      ...
      <div className="relative z-10 mx-auto w-full max-w-kv-container px-5 py-12 sm:py-14 lg:py-18 xl:py-20">
        <div className="min-w-0 max-w-[720px]">
          ...
          <p className="mt-5 max-w-[620px] text-base leading-relaxed text-white/78 sm:text-xl">
            Работаем с коммерческими объектами, земельными участками, складскими и гостиничными активами. Представляем интересы собственников и покупателей в сложных сделках.
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div className="rounded-kv-form border border-white/12 bg-white/6 p-4">
              ...
              <span className="mt-1 block text-[13px] text-white/68">объектов в общей витрине</span>
            </div>
            <div className="rounded-kv-form border border-white/12 bg-white/6 p-4">
              <span className="block text-3xl font-black text-white">5</span>
              <span className="mt-1 block text-[13px] text-white/68">объектов KVARTAL Moscow</span>
            </div>
            <div className="rounded-kv-form border border-white/12 bg-white/6 p-4">
              <span className="block text-3xl font-black text-white">RU / EN</span>
              <span className="mt-1 block text-[13px] text-white/68">двуязычная публичная витрина</span>
            </div>
          </div>
          ...
          <div id="request" className="mt-7 rounded-kv-main border border-white/16 bg-white/10 p-4 shadow-2xl backdrop-blur-xl sm:p-5">
            <div className="mb-3">
              ...
              <p className="mt-1 text-[13px] leading-snug text-white/68">Оставьте задачу, и мы свяжемся с вами по телефону +7 (977) 291-95-73.</p>
            </div>
            <form className="grid gap-2.5 sm:grid-cols-2 lg:grid-cols-[1fr,1fr] xl:grid-cols-[1fr,1fr,1.1fr,auto]">
              <input type="text" placeholder="Ваше имя" className="h-11 w-full rounded-kv-form bg-white px-3.5 text-sm text-kv-ink outline-none focus:ring-4 focus:ring-kv-gold/18" />
              ...
              <input type="text" placeholder="Задача и бюджет" className="h-11 w-full rounded-kv-form bg-white px-3.5 text-sm text-kv-ink outline-none focus:ring-4 focus:ring-kv-gold/18 sm:col-span-2 xl:col-span-1" />
