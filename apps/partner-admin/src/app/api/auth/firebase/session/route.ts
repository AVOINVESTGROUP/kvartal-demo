...
export async function POST(request: Request) {
  ...
  try {
    ...
    const allowed = canAccessAdminSurface(actor, "partner");
    if (!allowed || context.organizations.length === 0) throw new ActorAuthError("FORBIDDEN", 403, "This account has no Partner Admin access.");
