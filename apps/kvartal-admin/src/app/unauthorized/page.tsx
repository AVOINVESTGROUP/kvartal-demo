  ...
  return (
    <main className="grid min-h-screen place-items-center bg-kv-bg px-5 text-kv-ink">
      <section className="w-full max-w-[520px] rounded-md border border-kv-line bg-white p-6 shadow-sm">
        ...
        <h1 className="mt-2 text-2xl font-black text-kv-navy">Нет доступа к кабинету</h1>
        <p className="mt-3 text-sm leading-6 text-kv-muted">Аккаунт {session?.email ?? ""} подтверждён, но у него нет административной роли KVARTAL или роли владельца платформы.</p>
